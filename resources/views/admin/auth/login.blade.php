...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Attendence Management| Sign In</title>
			...
			<div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="login-aside d-flex flex-column flex-row-auto">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<!--end::Aside header-->
						{{-- <!--begin::Aside Title--> --}}
						<h3 class="font-weight-bolder text-center font-size-h1 text-dark-50 line-height-xl">Attendence Management
						<br />University Of Sargodha</h3> 
						<!--end::Aside Title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(100% + 5rem); background-image: url({{asset('assets/media/svg/illustrations/login-visual-4.svg')}})"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
				<div class="login-content flex-row-fluid d-flex flex-column p-10">
					...
					<div class="d-flex flex-row-fluid flex-center">
						...
						<div class="login-form">
							<!--begin::Form-->
							<form class="form" action="{{ route('admin.authenticate')}}" method="POST">
								<!--begin::Title-->
