...
@section('content')
    <div class="card card-custom">
        ...
        <td> <button type="button" class="btn btn-success m-r-20 btn-sm edit-btn"
                ...
                phone="{{ $user->phone }}"email="{{ $user->email }}"roll_no="{{ $user->roll_no }}"
            ...
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('edit-student') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group form-float">
                            <input type="text" class="form-control" id="roll_no" placeholder="Name" name="roll_no"
                                required>
                        </div>
                        <label>Guardian_name</label>
                        <div class="form-group form-float">
                            <input type="text" class="form-control" id="guardian_name" placeholder="Name" name="guardian_name"
                                required>
                        </div>
                        <label>Guardian_email</label>
                        <div class="form-group form-float">
                            <input type="text" class="form-control" id="guardian_email" placeholder="Name" name="guardian_email"
                                required>
                        </div>
