...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Attendence Management | @yield('title')</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed mb-5">
			<!--begin::Logo-->
			<a href="">
                <h5>Attendence Management</h5>
				{{-- <img alt="Logo" src="{{asset('front/img/logo/puff.png')}}" width="58px" /> --}}
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="" class="brand-logo">
							...
							{{-- <img alt="Logo" src="{{asset('front/img/logo/puff.png')}}" width="72px"/> --}}
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								{{-- <li class="menu-item {{Request::is('admin/server')?'menu-item-active':''}}" aria-haspopup="true">
								...
								<li class="menu-item {{Request::is('admin/content')?'menu-item-active':''}}" aria-haspopup="true">
									<a href="{{route('teacher.content.index')}}" class="menu-link">
										<i class="menu-icon flaticon2-indent-dots
										"></i>
										<span class="menu-text">Cource Content</span>
									</a>
								</li>
                               
						

								{{-- <li class="menu-item {{Request::is('admin/contact/index')?'menu-item-active':''}}" aria-haspopup="true">
									<a href="{{route('admin.contact.index')}}" class="menu-link">
										<i class="menu-icon flaticon-chat-2
										"></i>
										<span class="menu-text">New Messages</span>
									</a>
								</li>

								<li class="menu-item {{Request::is('admin/contact/history')?'menu-item-active':''}}" aria-haspopup="true">
									<a href="{{route('admin.contact.history')}}" class="menu-link">
										<i class="menu-icon flaticon-chat-2
										"></i>
										<span class="menu-text">Messages History</span>
									</a>
								</li> --}}
							</ul>
							<!--end::Menu Nav-->
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="" target="_blank" class="text-dark-75 text-hover-primary">BSITF19</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
		...
		<script src="{{asset('assets/plugins/custom/gmaps/gmaps.js?v=7.0.3')}}"></script>
		<!--end::Page Vendors-->
